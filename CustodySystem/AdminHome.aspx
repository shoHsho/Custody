...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <p style="color: #FF0000; font-size: xx-large;">
                  محتوى الأدمن</p>
                  <asp:Panel ID="permiPanel" runat="server" Height="456px" Width="568px"> <!-- style="visibility: hidden;"-->
    <br /> <asp:Button ID="viewB" runat="server" Text="View" Height="26px" Width="69px" 
                          onclick="viewB_Click" />
                      <br />
